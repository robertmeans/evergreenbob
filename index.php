...
<!--
  ...
  Comments:     Coded with love. And obsessive analyzing. But mostly love.
...
<head>
    ...
    <!-- Google Analytics -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-140046709-1"></script>
    <script>
      window.dataLayer = window.dataLayer || [];
      function gtag(){dataLayer.push(arguments);}
      gtag('js', new Date());

      gtag('config', 'UA-140046709-1');
    </script>
</head>
<body>
...
<div id="wrapper">
    ...
    <?php
        ...
        $fields_string = '';
        $fields = array(
            'secret' => '6LfdiaIUAAAAAPSPKkZRD0ShhH0nvnoxttw8HeNe',
    ...
    if (!$res['success']) {
        // fallback if Captcha not checked (not needed)
    } else {
        echo '<div id="success-wrap"><span class="success-msg">Yee Haw!<br />Success!</span></div>'; ?>
    <?php
        ...
        $subject = "Message From EvergreenBob.com Website";
        ...
        <div id="box-01" class="foo">
        	<form action="" method="post" id="contactForm" onSubmit="return validateEmail(document.forms[0].email.value);">	 
        		...
        		<ul>
        		  ...
        		  <li>
        		    <div class="g-recaptcha" data-theme="dark" data-callback="recaptchaCallback" data-sitekey="6LfdiaIUAAAAAHV3RmRM50lRM7vwn8LQmVpsU_vP"></div>
        		  </li>
        		  <li>
